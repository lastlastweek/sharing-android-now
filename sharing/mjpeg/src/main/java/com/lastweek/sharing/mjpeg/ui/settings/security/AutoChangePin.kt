package com.lastweek.sharing.mjpeg.ui.settings.security
...
import com.lastweek.sharing.common.ui.conditional
...
internal object AutoChangePin : ModuleSettings.Item {
    ...
    override fun ItemUI(horizontalPadding: Dp, coroutineScope: CoroutineScope, enabled: Boolean, onDetailShow: () -> Unit) {
        ...
        AutoChangePinUI(horizontalPadding, mjpegSettingsState.value.autoChangePin, mjpegSettingsState.value.enablePin) {
            if (mjpegSettingsState.value.autoChangePin != it) {
...
private fun AutoChangePinUI(
    ...
    Row(
        ...
        Icon(painter = painterResource(R.drawable.autorenew_24px), contentDescription = null, modifier = Modifier.padding(end = 16.dp))
