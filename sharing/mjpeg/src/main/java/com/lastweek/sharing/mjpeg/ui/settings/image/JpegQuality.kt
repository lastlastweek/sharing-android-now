package com.lastweek.sharing.mjpeg.ui.settings.image
...
private fun JpegQualityUI(
    ...
    Row(
        ...
        Icon(painter = painterResource(R.drawable.high_quality_24px), contentDescription = null, modifier = Modifier.padding(end = 16.dp))
