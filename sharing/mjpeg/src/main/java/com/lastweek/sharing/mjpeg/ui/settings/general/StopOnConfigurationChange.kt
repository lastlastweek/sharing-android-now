package com.lastweek.sharing.mjpeg.ui.settings.general
...
private fun StopOnConfigurationChangeUI(
    ...
    Row(
        ...
        Icon(painter = painterResource(R.drawable.video_settings_24px), contentDescription = null, modifier = Modifier.padding(end = 16.dp))
