...
import com.lastweek.sharing.AppConfig.DEFAULT_NETWORK
import com.lastweek.sharing.AppConfig.DNS_ALIDNS_ADDRESSES
import com.lastweek.sharing.AppConfig.DNS_ALIDNS_DOMAIN
import com.lastweek.sharing.AppConfig.DNS_CLOUDFLARE_ADDRESSES
import com.lastweek.sharing.AppConfig.DNS_CLOUDFLARE_DOMAIN
import com.lastweek.sharing.AppConfig.DNS_DNSPOD_ADDRESSES
import com.lastweek.sharing.AppConfig.DNS_DNSPOD_DOMAIN
import com.lastweek.sharing.AppConfig.DNS_GOOGLE_ADDRESSES
import com.lastweek.sharing.AppConfig.DNS_GOOGLE_DOMAIN
import com.lastweek.sharing.AppConfig.DNS_QUAD9_ADDRESSES
import com.lastweek.sharing.AppConfig.DNS_QUAD9_DOMAIN
import com.lastweek.sharing.AppConfig.DNS_YANDEX_ADDRESSES
import com.lastweek.sharing.AppConfig.DNS_YANDEX_DOMAIN
import com.lastweek.sharing.AppConfig.GEOIP_CN
import com.lastweek.sharing.AppConfig.GEOSITE_CN
import com.lastweek.sharing.AppConfig.GEOSITE_PRIVATE
import com.lastweek.sharing.AppConfig.GOOGLEAPIS_CN_DOMAIN
import com.lastweek.sharing.AppConfig.GOOGLEAPIS_COM_DOMAIN
import com.lastweek.sharing.AppConfig.HEADER_TYPE_HTTP
import com.lastweek.sharing.AppConfig.LOOPBACK
import com.lastweek.sharing.AppConfig.PROTOCOL_FREEDOM
import com.lastweek.sharing.AppConfig.TAG_BLOCKED
import com.lastweek.sharing.AppConfig.TAG_DIRECT
import com.lastweek.sharing.AppConfig.TAG_FRAGMENT
import com.lastweek.sharing.AppConfig.TAG_PROXY
import com.lastweek.sharing.AppConfig.WIREGUARD_LOCAL_ADDRESS_V4
import com.lastweek.sharing.AppConfig.WIREGUARD_LOCAL_ADDRESS_V6
import com.lastweek.sharing.dto.ConfigResult
import com.lastweek.sharing.dto.EConfigType
import com.lastweek.sharing.dto.NetworkType
import com.lastweek.sharing.dto.ProfileItem
import com.lastweek.sharing.dto.RulesetItem
import com.lastweek.sharing.dto.V2rayConfig
import com.lastweek.sharing.dto.V2rayConfig.RoutingBean.RulesBean
import com.lastweek.sharing.extension.isNotNullEmpty
import com.lastweek.sharing.fmt.HttpFmt
import com.lastweek.sharing.fmt.Hysteria2Fmt
import com.lastweek.sharing.fmt.ShadowsocksFmt
import com.lastweek.sharing.fmt.SocksFmt
import com.lastweek.sharing.fmt.TrojanFmt
import com.lastweek.sharing.fmt.VlessFmt
import com.lastweek.sharing.fmt.VmessFmt
import com.lastweek.sharing.fmt.WireguardFmt
import com.lastweek.sharing.util.JsonUtil
