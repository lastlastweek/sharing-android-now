...
internal object AppLogger {
    ...
    internal fun enableLogging(context: Context) {
        ...
        isLoggingOn = true
        Toast.makeText(context, context.getString(R.string.app_logs_enabled_T), Toast.LENGTH_LONG).show()
        GlobalScope.launch {
    ...
    internal fun disableLogging(context: Context) {
        ...
        isLoggingOn = false
        Toast.makeText(context, context.getString(R.string.app_logs_disabled_T), Toast.LENGTH_LONG).show()
        GlobalScope.launch {
    ...
    internal suspend fun sendLogsInEmail(context: Context, text: String) {
        ...
        runCatching {
            context.startActivity(
                Intent.createChooser(emailIntent, context.getString(R.string.app_tab_about_email_chooser_header_T))
