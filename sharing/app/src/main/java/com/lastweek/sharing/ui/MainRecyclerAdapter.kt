...
import com.lastweek.sharing.AngApplication.Companion.application
import com.lastweek.sharing.AppConfig
import com.lastweek.sharing.R
import com.lastweek.sharing.databinding.ItemQrcodeBinding
import com.lastweek.sharing.databinding.ItemRecyclerFooterBinding
import com.lastweek.sharing.databinding.ItemRecyclerMainBinding
...
import com.lastweek.sharing.extension.toastSuccess
import com.lastweek.sharing.handler.AngConfigManager
import com.lastweek.sharing.handler.MmkvManager
import com.lastweek.sharing.helper.ItemTouchHelperAdapter
import com.lastweek.sharing.helper.ItemTouchHelperViewHolder
...
class MainRecyclerAdapter(val activity: MainActivity) : RecyclerView.Adapter<MainRecyclerAdapter.BaseViewHolder>(), ItemTouchHelperAdapter {
    ...
    class MainViewHolder(val itemMainBinding: ItemRecyclerMainBinding) : BaseViewHolder(itemMainBinding.root), ItemTouchHelperViewHolder

    class FooterViewHolder(val itemFooterBinding: ItemRecyclerFooterBinding) : BaseViewHolder(itemFooterBinding.root)
