...
import com.lastweek.sharing.databinding.ItemRecyclerRoutingSettingBinding
...
class RoutingSettingRecyclerAdapter(val activity: RoutingSettingActivity) : RecyclerView.Adapter<RoutingSettingRecyclerAdapter.MainViewHolder>(),
    ...
    class MainViewHolder(val itemRoutingSettingBinding: ItemRecyclerRoutingSettingBinding) : BaseViewHolder(itemRoutingSettingBinding.root), ItemTouchHelperViewHolder
