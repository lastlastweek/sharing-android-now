...
internal fun CollectingLogsUi(modifier: Modifier = Modifier) {
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.app_logs_collecting_T),
            ...
            Row(
                ...
                OutlinedButton(
                    ...
                    Text(
                        text = stringResource(id = R.string.app_logs_send_title_T),
                ...
                OutlinedButton(
                    ...
                    Text(
                        text = stringResource(id = R.string.app_logs_stop_T),
                        color = MaterialTheme.colorScheme.onError,
                        textAlign = TextAlign.Center
                    )
                }
            ...
            if (showBottomSheet.value) {
                ModalBottomSheet(
                    ...
                    Text(
                        text = stringResource(id = R.string.app_logs_send_message_T),
                        modifier = Modifier
                            .fillMaxWidth()
                    ...
                    Row(
                        ...
                        ) { Text(text = stringResource(id = R.string.app_logs_send_T)) }
